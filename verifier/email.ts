...
export const sendWebsiteAlertEmail = async (email: string, websiteUrl: string) => {
...
export const sendLowBalanceEmail = async (email: string, websiteUrl: string, balance: string) => {
  const transporter = nodemailer.createTransport({
    service: 'Gmail',
    auth: {
      user: process.env.email,
