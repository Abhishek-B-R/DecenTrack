    ...
    <header className="sticky top-0 z-40 w-full border-b bg-background lg:pl-20 xl:pl-40">
      <div className="container flex h-16 items-center justify-between py-4">
        <div className="flex items-center gap-2">
          <Shield className="h-6 w-6 text-primary dark:text-cyan-700" />
        ...
        <nav className="flex items-center gap-2 md:gap-4">
          <Link
            href="/add-new"
            className="text-sm font-medium hover:text-primary sm:block hidden"
          >
          ...
          <Button
            ...
            onClick={() => {
              window.open(
                "https://www.github.com/Abhishek-B-R/DecenTrack",
                "_blank",
                "noopener,noreferrer"
              );
            }}
