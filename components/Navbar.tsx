...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-40 w-full border-b bg-background xl:pl-40">
      <div className="container flex h-16 items-center justify-between py-4">
        ...
        <nav className="flex items-center gap-4">
          <Link href="/lister" className="text-sm font-medium hover:text-primary sm:block hidden">
