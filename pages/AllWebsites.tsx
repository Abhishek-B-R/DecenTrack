    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <p>
              The monitoring context is not available. Please check your context
              provider.
            </p>
          </CardContent>
        </Card>
    ...
    return (
      <div className="container mx-auto p-6 space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            If this loading doesn&apos;t stop, then make sure your metamask
            wallet has SepoliaETH as default network
          </AlertDescription>
        </Alert>
      ...
      {websites.length === 0 ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              You don&apos;t have any websites configured for monitoring.
            </CardDescription>
          </CardHeader>
          <Alert>
            <AlertTitle>Tips:</AlertTitle>
            <AlertDescription>
              If you had some websites,then make sure your metamask wallet has
              SepoliaETH network as default network
            </AlertDescription>
          </Alert>
        </Card>
      ) : (
          ...
          >
            <CardHeader className="flex flex-row items-start justify-between">
              ...
              <div className="flex items-center gap-2 -ml-40 md:-ml-0">
                <Badge
                  className={website.disabled ? "bg-red-500" : "bg-green-500"}
                >
